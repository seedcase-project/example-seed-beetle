...
df = (
    ...
    .rename(
        {
            "o2":"o2_consumed", "co2":"co2_produced", "mt_dna_haplotype":"mitochondrial_dna_lineage"
        , "nc_genotype":"nuclear_lineage", "treatment":"mating_treatment", "coevol":"coadaptation"
        , "w_v": "virgin_body_weight", "w_m1":"body_weight_after_mating"
        , "w_m1r": "mated_body_weight_after_respirometry", "ejac1":"ejaculate_weight_first_mating"
        , "ejac2":"ejaculate_weight_second_mating", "copuldur_1":"copulation_duration_first_mating"
